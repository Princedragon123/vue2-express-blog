...
// ┌─────────────────────────────────────────────────────────────────────────┐
// │  1. 私信权限控制：相互关注才能发消息                                    │
// │  2. WebSocket实时推送：消息发送后立即通知                               │
// │  3. 消息状态管理：sent → delivered → read                              │
// │  4. 分页查询：skip + limit模式                                         │
// │  5. 批量操作：批量发送分享消息                                          │
// └─────────────────────────────────────────────────────────────────────────┘
// 
...
// 
// Q4: 为什么同时创建Notification和Message？
...
const messageController = {
    ...
    // 获取与特定用户的消息历史
    // ============================================================
    // 【路由】GET /api/messages/history/:userId
    // 【作用】获取与指定用户的所有聊天记录
    // 
    // 【路由参数】
    // - userId: 目标用户ID
    ...
    // A: 确保消息持久化，离线用户也能收到
    // 
    // Q3: sendMessage和sendNotification区别？
