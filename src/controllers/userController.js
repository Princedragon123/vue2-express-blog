...
// │       │                                                                 │
// │       ├── 4. 创建关注记录                                              │
// │       │   Follow.create({ follower: A, following: B })                 │
// │       │                                                                 │
// │       ├── 5. 检查是否相互关注                                          │
// │       │   if (B也关注了A) isMutualFollowing = true                     │
// │       │                                                                 │
// │       ├── 6. 创建通知                                                  │
// │       │   Notification.create({ receiver: B, sender: A, type: 'follow' })│
// │       │                                                                 │
// │       └── 7. WebSocket 推送通知                                        │
// │           socketService.sendNotification(B, notification)              │
// │                                                                         │
// └─────────────────────────────────────────────────────────────────────────┘
// 
// 【隐私控制】
...
// │  【隐私设置】                                                            │
// │  - publicPosts: 是否公开文章                                           │
// │  - publicLikes: 是否公开点赞列表                                       │
// │  - publicBookmarks: 是否公开收藏列表                                   │
// │  - publicFollowList: 是否公开关注/粉丝列表                             │
// │                                                                         │
// │  【访问规则】                                                            │
// │  - 用户本人：可以查看所有内容                                           │
// │  - 管理员：可以查看所有内容                                             │
...
const UserController = {
    ...
    changePassword: async (req, res) => {
        try {
            ...
            // 更新密码
            // 【注意】密码会在 User 模型的 pre save 钩子中自动加密
